...
- Agent Mode enabled
- The rule system files placed under `/docs/rules/` in your repository:
  ```
  /docs/rules/
      integration-architecture-rule-system/
          README.md
...
This repository includes the **Integration Architecture Rule System** under `/docs/rules/`.
It is your **normative authority** for integration architecture decisions.

### Rule System Files (load order)

1. `/docs/rules/integration-architecture-rule-system/00-scope.md` — scope definition
2. `/docs/rules/integration-architecture-rule-system/01-design-principles.md` — design principles (P01–P25)
3. `/docs/rules/integration-architecture-rule-system/02-decision-model.md` — decision rules (D01–D14)
4. `/docs/rules/integration-architecture-rule-system/03–pattern-selection-rules.md` — pattern selection (PR01–PR15)
5. `/docs/rules/integration-architecture-rule-system/04–non-functional-architecture-rules.md` — NFR rules (NFR01–NFR12)
6. `/docs/rules/integration-architecture-rule-system/05–validation-checklist.md` — validation checklist (V01–V12)
7. `/docs/rules/integration-architecture-rule-system/06–agent-integration-layer.md` — agent execution model
...
```
Read the Integration Architecture Rule System under /docs/rules/.
