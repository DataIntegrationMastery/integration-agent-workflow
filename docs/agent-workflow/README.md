...
- The file `docs/agent-workflow/installation/agent-workflow-setup-guide.md` exists 
- The directory `docs/agent-workflow/rules` exists 
...
docs/agent-workflow/installation/agent-workflow-setup-guide.md
...
For each OPTION found in docs/agent-workflow/installation/agent-workflow-setup-guide.md:
...
3. Verify TASK structure under `/docs/agent-workflow/tasks/`
...
| File | Purpose |
|------|---------|
| `docs/agent-workflow/rules/project-context.md` | Defines project name, runtime, framework, API spec locations, deployment model |
| `docs/agent-workflow/rules/technology-stack.md` | Defines mandatory technology constraints, allowed/forbidden libraries, conventions |

**These files contain placeholder values.** You must:

1. Open `docs/agent-workflow/rules/project-context.md` and replace all `[...]` placeholders with your actual project details
2. Open `docs/agent-workflow/rules/technology-stack.md` and define your actual technology rules and constraints
